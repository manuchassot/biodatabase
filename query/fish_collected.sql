...
DROP TABLE IF EXISTS fish_collected;
CREATE TEMP TABLE fish_collected AS
...
-- Export the table
\copy fish_collected TO '/home/stagiaire/Emotion3/queries/FISH/fish_collected.csv' WITH DELIMITER ';' CSV HEADER
