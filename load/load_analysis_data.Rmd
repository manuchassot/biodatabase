...
pfc_analysis <- pfc[, .(analysis_id=talend_an_id,sample_id=sample_identifier,analysis_type=analysis,analysis_replicate,analysis_lab,analysis_operator=operator_name,analysis_sample_description,analysis_mode,analysis_date,remarks_analysis,data_file_name=NA,analysis_mass=NA,analysis_mass_unit=NA,analysis_date_check=NA)]
