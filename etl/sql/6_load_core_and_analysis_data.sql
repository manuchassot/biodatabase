...
SELECT subsample_identifier, operator_name, location, sample_identifier, packaging_1, lower(storage_mode_1), storage_date, drying_mode, drying_date, packaging_final, lower(storage_mode_final), grinding_mode, remarks_analysis FROM import.co_data_prep WHERE sample_identifier IN (SELECT id FROM co_sample);
